...
export default function Signin() {
  ...
  useEffect(() => {
    ...
    for (let i = 0; i < 8; i++) {
      ...
      sphere.position.set(Math.random() * 30 - 15, 15 + Math.random() * 2, Math.random() * 30 - 15);
      scene.add(sphere);
      spheres.push(sphere);
    }
          ...
          <div className="flex gap-4 mb-6">
            <button className="flex-1 flex items-center justify-center gap-2 border border-gray-300 py-2 rounded-md">
              <svg className="w-5 h-5" viewBox="0 0 533.5 544.3" xmlns="http://www.w3.org/2000/svg">
                <path d="M533.5 278.4..." fill="#4285f4" />
                <path d="M272 544.3..." fill="#34a853" />
                <path d="M119.5 325.2..." fill="#fbbc04" />
                <path d="M272 107.7..." fill="#ea4335" />
              </svg>
              Google
            </button>
            <button className="flex-1 flex items-center justify-center gap-2 border border-gray-300 py-2 rounded-md">
